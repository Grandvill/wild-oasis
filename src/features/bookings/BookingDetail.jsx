    ...
    <>
      <Row type="horizontal">
        <HeadingGroup>
          ...
          {status ? <Tag type={statusToTagName[status]}>{status.replace('-', ' ')}</Tag> : null}
        </HeadingGroup>
      ...
      <ButtonGroup>
        ...
        <Modal>
          ...
          <Modal.Window name="delete">
            {/* onSettled navigate -1 artinya setelah booking berhasil terhapus langsung kembali ke halaman sebelumnya */}
