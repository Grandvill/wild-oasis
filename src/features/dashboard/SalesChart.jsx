...
function SalesChart({ bookings, numDays }) {
  ...
  return (
    <StyledSalesChart>
      <Heading as="h2">
        Sales from {format(allDates.at(0), 'MMM dd')} &mdash; {format(allDates.at(-1), 'MMM dd')}
      </Heading>
      ...
      <ResponsiveContainer height={300} width="100%">
        <AreaChart data={data}>
          ...
          <Area dataKey="extrasSales" type="monotone" stroke={colors.extrasSales.stroke} fill={colors.extrasSales.fill} strokeWidth={2} unit="$" name="Extras sales" />
        </AreaChart>
      </ResponsiveContainer>
    </StyledSalesChart>
  );
